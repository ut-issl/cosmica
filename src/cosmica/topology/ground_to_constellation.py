...
@deprecated("Use the build_*_g2c_topology() functions instead.")
...
@deprecated("Use build_elevation_based_g2c_topology() instead.")
...
@deprecated("Use build_manual_g2c_topology() instead.")
