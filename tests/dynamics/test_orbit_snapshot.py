...
class TestCircularOrbitPropagatorSnapshot:
    """Snapshot tests for CircularSatelliteOrbitPropagator.

    These tests verify that the circular orbit propagation produces
    consistent results across different scenarios.
    """

    def test_equatorial_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_polar_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_inclined_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_full_orbit_period_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_geostationary_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_leo_constellation_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_propagate_from_epoch_snapshot(self, snapshot: SnapshotAssertion) -> None:
...
class TestEllipticalOrbitPropagatorSnapshot:
    """Snapshot tests for EllipticalSatelliteOrbitPropagator.

    These tests verify that the elliptical orbit propagation (using SGP4)
    produces consistent results across different scenarios.
    """

    def test_circular_case_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_eccentric_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_highly_eccentric_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_iss_like_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_teme_reference_frame_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_j2000_reference_frame_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_gto_orbit_snapshot(self, snapshot: SnapshotAssertion) -> None:
...
class TestSunDynamicsSnapshot:
    """Snapshot tests for sun direction calculations.

    These tests verify that the sun direction calculation produces
    consistent results for various times throughout the year.
    """

    def test_sun_direction_single_time_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_sun_direction_daily_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_sun_direction_seasonal_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_sun_direction_yearly_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_sun_direction_equinox_solstice_snapshot(self, snapshot: SnapshotAssertion) -> None:
    ...
    def test_sun_direction_intraday_snapshot(self, snapshot: SnapshotAssertion) -> None:
